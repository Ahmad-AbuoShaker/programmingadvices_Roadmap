...
void CopyArrayUsingAddArrayElement(int arr1[100], int arr2[100], int length1, int& arr2length) {
    arr2length = 0;
...
int main()
{
    ...
    CopyArrayUsingAddArrayElement(arr1, arr2, Length1, Length2);
    //CopyArray(arr1, arr2, Length1);
    cout << "\n Element of array 1 : ";
