...
public:
    ...
    static int Sum_Print_OfDigits(int Num)
    {
    ...
    static int CountDigitFrequency(short DigitToCheck, int Num) {
    ...
    static void PrintFibonacciUsingLoop(int number, int Preves1, int Preves2) {
        int FebNumber;
